...
AS (
    ...
    SELECT
        ...
        N'gabriella.mottica@cesimultimedia.it;cipriani@cesimultimedia.it;paola.turolla@cesimultimedia.it;andrea.giuggioli@cesimultimedia.it;angela.battaglia@cesimultimedia.it;giada.lidonnici@cesimultimedia.it;serena.leso@cesimultimedia.it;nicola.mastropietro@cesimultimedia.it;anna.defeudis@cesimultimedia.it;paolo.dosi@cesimultimedia.it;direzione.vendite@partnerup.it;valentina.cipriani@cesimultimedia.it',
        N'Report Accessi',
        NULL
